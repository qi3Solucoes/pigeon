package br.com.qisi.pigeon.utils.base.service;

import br.com.qisi.pigeon.utils.BeansUtil;
import br.com.qisi.pigeon.utils.base.model.BaseModel;
import br.com.qisi.pigeon.utils.base.repository.BaseRepository;
import br.com.qisi.pigeon.utils.base.utils.Command;
import br.com.qisi.pigeon.utils.exception.BadRequestException;
import br.com.qisi.pigeon.utils.exception.NotFoundException;
import br.com.qisi.pigeon.utils.specification.BaseSpecification;
...
public class BaseService<T extends BaseModel>{
  ...
  public T pathNonNull(T t) {
    ...
    T tPersistido = this.findById(t.getId()).<RuntimeException>orElseThrow(() -> {
